...
- `.claude/skills/task1-architecture/SKILL.md` — provider and data flow
- `.claude/skills/realtime-data/SKILL.md` — validation, normalization, freshness
- `.claude/skills/mock-scenarios/SKILL.md` — authored scenario data
- `.claude/skills/safety-visualization/SKILL.md` — actual-versus-safe presentation
- `.claude/skills/testing/SKILL.md` — verification discipline
...
Governed in full by `.claude/skills/safety-visualization/SKILL.md`. That skill is
...
Governed by `.claude/skills/testing/SKILL.md`. HMI-specific requirements follow.
