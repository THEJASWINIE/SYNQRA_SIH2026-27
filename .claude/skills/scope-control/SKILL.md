...
The authoritative project-level instruction set is the **root `CLAUDE.md`**. This skill
does not override it and must never contradict it. Where this skill is silent, `CLAUDE.md`
governs.
...
Before implementing, check whether it already exists (`CLAUDE.md` §4, §27). If two
