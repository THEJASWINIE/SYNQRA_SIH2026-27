...
import { fleetPositions, providerForMode, type SystemMode } from "../state/vehiclePosition";
...
/**
 * Resizable side columns (DIGITAL-TWIN-OPERATIONAL-FLOW-01): the viewer drags the gutters
 * to trade width between fleet / map / selected. Presentation state only; the map column
 * always keeps at least 40% of the deck.
 */
const S1_TRACKS = {
  fleet: { axis: "x", index: 0, minPx: 180, maxPx: 560 },
  selected: { axis: "x", index: 2, minPx: 220, maxPx: 640 },
} as const;
...
export function OperationsOverview({
  ...
  */
  ...
  const tracks = useTrackLayout("control-room-s1", S1_TRACKS);
      ...
      <header className="cr-topbar" role="banner">
        ...
        <div className="cr-status-group">
          <div
            ...
            data-feed={isReplay ? "REPLAY" : isConnected ? "LIVE" : "DISCONNECTED"}
          >
      ...
      >
        <div className="grid-2" style={{ display: "contents" }}>
                ...
                <div className="cr-selected-body" data-vehicle-id={selectedVehicle.vehicleId}>
                  <div className="cr-selected-head">
                    ...
                    <span className="cr-badge cr-badge-info">
                      {selectedVehicle.mode ?? "UNAVAILABLE"}
                    </span>
                  </div>
                    ...
                    <table className="data-table cr-compact-table">
                      <tbody>
                        ...
                        <tr>
                          <td>Headway</td>
                          <td className="mono">
                            {selectedSafety.headwayCurrent !== null &&
                            Number.isFinite(selectedSafety.headwayCurrent)
                  ...
                  <table className="data-table cr-compact-table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <span aria-hidden="true">
                            {LINK_STATE_GLYPH[v2vLink?.state ?? "UNAVAILABLE"]}
                          </span>{" "}
                      ...
                      <tr>
                        ...
                        <td>
                          <span aria-hidden="true">
                            {LINK_STATE_GLYPH[v2iLink?.state ?? "UNAVAILABLE"]}
                          </span>{" "}
          ...
          <TrackGutter
            ...
            track="fleet"
            edge="end"
            label="Fleet column width"
            className="cr-gutter-fleet"
          />
          <TrackGutter
            layout={tracks}
            track="selected"
            edge="start"
            label="Selected vehicle column width"
            className="cr-gutter-selected"
          />
        </div>
      </div>
